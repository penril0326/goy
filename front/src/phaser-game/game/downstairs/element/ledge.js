...
class Ledge extends Phaser.Sprite {
    constructor(game, x, y) {
        super(game, x, y, Config.LedgesAtlasName, Config.LedgesAtlasKey.NormalLedge);
    ...
    randLedgeType(ledgeSetting) {
        ...
        let randomIndex = Math.getRandomInt(0, ledgeSetting.length - 1);
    ...
    initAnimation() {
        this.animations.add(
            ...
            GlobalConst.DefaultAnimationFrameRate + 10,
            false,
            false
        );
        this.animations.add(
            ...
            GlobalConst.DefaultAnimationFrameRate,
            true,
            false
        );
        this.animations.add(
